...
/**
 * Created by jinq on 2017/3/8.
 */
public class MycatSQLServerStatementParser extends SQLServerStatementParser
{
    private static final String LOW_PRIORITY   = "LOW_PRIORITY";
    private static final String LOCAL          = "LOCAL";
    private static final String IGNORE         = "IGNORE";
    private static final String CHARACTER      = "CHARACTER";
    public MycatSQLServerStatementParser(String sql)
    {
        super(sql);
        selectExprParser = new MycatSQLServerExprParser(sql);
    }

    public MycatSQLServerStatementParser(Lexer lexer)
    {
        super(lexer);
        selectExprParser = new MycatSQLServerExprParser(lexer);
    }
    ...
    public SQLSelectStatement parseSelect()
    {
    	...
    	MycatSQLServerSelectParser selectParser = new MycatSQLServerSelectParser(this.selectExprParser);
//    	
        return new SQLSelectStatement(selectParser.select(), JdbcConstants.SQL_SERVER);
    }
